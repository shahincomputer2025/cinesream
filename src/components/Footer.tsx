    ...
    <footer className="bg-card border-t border-border mt-20 pb-20 md:pb-0">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/watchlist" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Watchlist
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {currentYear} CineStream. All rights reserved. Movie data provided by TMDB.</p>
        </div>
      </div>
    </footer>
  );
